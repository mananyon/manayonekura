...
bullets(s,M,2.05,7.3,[
  ...
  [{text:'扱うのは睡眠そのものではなく、'},{text:'思考が止まらない状態',b:1},{text:'です。眠れないの手前にある、頭が休まらない時間に手を入れます。'}],
...
quote(s,M,5.0,CW,1.45,'本日お願いしたいこと',[{text:'生きづらさを抱えた人を、治療が必要になる手前で減らしたい。そのために、鍼灸の外側にある方法も含めて手を尽くします。'},{text:'まずは本日、この3つのうちどこに可能性がありそうか、率直なご意見をいただけたら嬉しいです。',options:{bold:true,color:INK}}],SHU);
foot(s,'4:35 → 5:00');
