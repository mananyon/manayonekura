...
hr(s,M,4.95,CW);
const stats=[['12年目','鍼灸院 開業'],['20,000人+','のべ臨床患者数'],['3学会','発表・登壇'],['修士','武蔵野大学大学院 人間学']];
stats.forEach((st,i)=>{
  const x=M+i*(CW/4);
...
rows.forEach((r,i)=>{
  ...
  s.addText(r[1],{x:RX,y,w:RW,h:0.9,fontSize:14,fontFace:SANS,color:INK2,isTextBox:true,margin:0,valign:'top',lineSpacing:18});
});
...
title(s,'正直に言うと、私1人で抱えられる量に天井があります');
